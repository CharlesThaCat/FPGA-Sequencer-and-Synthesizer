...
set rc [catch {
  ...
  catch { write_mem_info -force pwm_sine.mmi }
  write_bitstream -force pwm_sine.bit 
  catch {write_debug_probes -quiet -force pwm_sine}
  catch {file copy -force pwm_sine.ltx debug_nets.ltx}
